...
public class NewzActivity extends AppCompatActivity {
    ArrayList<BdModelClass> dataitem = new ArrayList<>();
    RecyclerView recyclerView;
    BdAdapter bdAdapter;
    RequestQueue requestQueue;
    String url = "https://api.myjson.com/bins/gqtmf";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_newz);
        recyclerView = findViewById(R.id.rvnewzplayerdetails);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray jsonArray=jsonObject.getJSONArray("newzealand");
