...
public class PakActivity extends AppCompatActivity {
    ArrayList<BdModelClass> dataitem = new ArrayList<>();
    RecyclerView recyclerView;
    BdAdapter bdAdapter;
    RequestQueue requestQueue;
    String url = "https://api.myjson.com/bins/15t66v";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pak);
        recyclerView = findViewById(R.id.rvpakplayerdetails);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray jsonArray=jsonObject.getJSONArray("pakistan");
